  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-10 font-inter">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          type="submit"
          className="bg-cBrightBlue border border-cDarkBlue text-cWhite px-4 py-2 rounded-lg hover:bg-cWhite hover:text-cDarkBlue transition ease-in-out"
        >
          Upload
        </button>
      </form>
                ...
                <div className="flex overflow-x-auto mt-2 items-center justify-center ">
                  {filteredData[key].length === 0 ? (
                    ...
                    <table className="w-full border border-CPurple  mt-2">
                      <thead>
                        <tr className="bg-cBrightBlue text-cWhite ">
