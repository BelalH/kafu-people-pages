...
const cards = [
  ...
  },
  {
    ...
    title: "Our Services",
    description:
      "KAFUPEOPLE provides a wide range of IT services that cater to your business needs, from cloud computing and cybersecurity to system integration and digital transformation consulting. Our expert team is committed to delivering personalized solutions that optimize your business performance and ensure long-term success in the digital era.",
    cta: "Learn More",
    link: "/services",
  },
];
...
const Features = () => {
  return (
    <section className="bg-cBrightBlue text-cWhite  py-8 px-4 sm:py-16 sm:px-8 lg:px-32 font-inter">
